jQuery(document).ready(function($){
  ...
  $('span.start-game').on('click',function(){
    ...
    $('.container-answer video').attr('src','assets/video/QUIZ MEDIOEVO 3 X/DOMANDA 1 LONGOBARDI.mp4');
  ...
  $('.box').on('click',function(){
    ...
    //Domande
    let domanda_1 = 'Quali sono i luoghi d’origine del popolo longobardo?';
    let domanda_2 = 'Quali oggetti presenti nella sepoltura puoi trovare anche all’interno delle vetrinette qui intorno?';
    let domanda_3 = 'Come si chiama la tipica arma usata dai longobi?';
    let domanda_4 = 'domanda 4';
    let video_1 = "assets/video/QUIZ MEDIOEVO 3 X/DOMANDA 1 LONGOBARDI.mp4";
    let video_2 = "assets/video/QUIZ MEDIOEVO 3 X/DOMANDA 2 LONGOBARDI.mp4";
    let video_3 = "assets/video/QUIZ MEDIOEVO 3 X/DOMANDA 3 LONGOBARDI.mp4";
    let r_1 = 'Penisola scandinava';
    let r_2 = 'Pannonia';
    let r_3 = 'Russia';
    let r_4 = 'Islanda';
    let r_5 = 'Punte di freccia';
    let r_6 = 'Scudo';
    let r_7 = 'Calzature di cuoio';
    let r_8 = 'Un menhir';
    let r_9 = 'Lancia';
    let r_10 = 'Martello da guerra';
    let r_11 = 'Scramasax';
    let r_12 = 'Ascia';
