jQuery(document).ready(function($){
  ...
  $('span.start-game').on('click',function(){
    ...
    $('.container-answer video').attr('src','assets/video/QUIZ RISORGIMENTO 3 X/DOMANDA 1 RISORGIMENTO.mp4');
  ...
  $('.box').on('click',function(){
    ...
    //Domande
    let domanda_1 = 'Quale antico stato è rappresentato nella cartina?';
    let domanda_2 = 'Chi è il primo re di Italia?';
    let domanda_3 = 'Guardando la cartina in che regno si trovava Carignano?';
    let domanda_4 = 'domanda 4';
    let video_1 = "assets/video/QUIZ RISORGIMENTO 3 X/DOMANDA 1 RISORGIMENTO.mp4";
    let video_2 = "assets/video/QUIZ RISORGIMENTO 3 X/DOMANDA 2 RISORGIMENTO.mp4";
    let video_3 = "assets/video/QUIZ RISORGIMENTO 3 X/DOMANDA 3 RISORGIMENTO.mp4";
    let r_1 = 'Lombardo-Veneto';
    let r_2 = 'Stato pontificio';
    let r_3 = 'Regno delle due Sicilie';
    let r_4 = 'Regno di Sardegna';
    let r_5 = 'Carlo Alberto';
    let r_6 = 'Carlo Martello';
    let r_7 = 'Vittorio Emanuele II';
    let r_8 = 'Luigi XIV';
    let r_9 = 'Regno delle due Sicilie';
    let r_10 = 'Regno di Sardegna';
    let r_11 = 'Impero asburgico';
    let r_12 = 'Stato pontificio';
    ...
    $('.next-start').on('click', function(){
      if ($(this).hasClass('next-start')) {
        ...
        $('.box:first-child').attr('data-success','false').find('h3').text(r_5);
        ...
        $('.box:nth-child(3)').attr('data-success','true').find('h3').text(r_7);
        ...
        $('.box:first-child').attr('data-success','true').find('h3').text(r_1);
        $('.box:first-child').find('img').attr('src','assets/img/1.png');
        $('.box:nth-child(2)').attr('data-success','false').find('h3').text(r_2);
